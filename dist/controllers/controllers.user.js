  ...
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          hash = _context.sent;
          //Para encripta cla contraseña, funciones externas se le ponen await
          clave = hash;
          _context.next = 10;
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 8:
          ...
          if (respuesta[0].affectedRows == 1) {
            (0, _browser.success)(req, res, 201, "Usuario creado:" + usuario);
          } else {
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 4:
          ...
          if (respuesta[0].affectedRows == 1) {
            (0, _browser.success)(req, res, 201, "se ha eliminadp el usuario");
          } else {
...
var logueoUsuario = exports.logueoUsuario = /*#__PURE__*/function () {
  var _ref6 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(req, res) {
    var _req$body, usuario, clave, respuesta, match, payloan, token;
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _req$body = req.body, usuario = _req$body.usuario, clave = _req$body.clave; // hay que comparar contraseña de la base de datos a la que le estamos mandando
          _context6.prev = 1;
          _context6.next = 4;
        ...
        case 14:
          ...
          _context6.next = 17;
          return _jsonwebtoken["default"].sign(payloan, process.env.TOKEN_PRIVATEKEY, {
        ...
        case 21:
          ...
          (0, _browser.error)(req, res, 500, "Error em el servidor, por favor intentelo de nuevo");
        case 24:
        case "end":
